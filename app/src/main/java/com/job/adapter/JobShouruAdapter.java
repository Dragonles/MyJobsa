...
public class JobShouruAdapter extends BaseAdapter {
    ...
    public JobShouruAdapter(Context context, List<CompanyRelease> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView= LayoutInflater.from(context).inflate(R.layout.list_jobincome_item,null);
        ...
        holder.lc_money.setText(list.get(position).getCr_salary()+"元");
        return convertView;
    }
    class ViewHolder {
